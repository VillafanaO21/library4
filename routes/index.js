...
router.post('/books/edit/:id', bookController.updateBooks);

router.get('/books/add', bookController.renderAddForm);

router.post('/books/add', bookController.addCourse);
...
router.post('/authors/:bookId/enroll', bookController.enrollAuthors);

router.get('/authors/:bookId/removeAuthor/:studentId', bookController.removeAuthor);
