...
router.post('/students/:studentId/enroll/', studentsController.enrollStudent);

router.get('/students/:studentId/removeCourse/:courseId', studentsController.removeCourse)
